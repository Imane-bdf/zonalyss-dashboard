...
geojson_url = "https://raw.githubusercontent.com/Imane-bdf/zonalyss-dashboard/main/luxembourg_communes_real.geojson"
...
fig = px.choropleth_mapbox(
    ...
    featureidkey="properties.commune", # Update this once you know the exact key in GeoJSON
    zoom=8,
